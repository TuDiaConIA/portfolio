...
type ConverterFormDocumentProps = {
    fromFormat: string
    toFormat: string
    lockFrom?: boolean
    }

    // SOLO combinaciones soportadas
    ...
    export default function ConverterFormDocument({
    fromFormat,
    toFormat,
    lockFrom = false
    }: ConverterFormDocumentProps) {
    ...
    useEffect(() => {
        // Cambia "to" automáticamente si el anterior ya no es válido
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
            {loading ? 'Convirtiendo...' : 'Convertir documentos'}
            </button>
        </form>
        </section>
    )
